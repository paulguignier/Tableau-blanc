 ...
 */
function findShortestPath(allCombinations, changeTime) {
 ...
 */
function calculateCompletePath(combination, changeTime) {
    let completePath = [];
    let totalDistance = 0;
 ...
 */
function calculatePathTime(path, changeTime) {
    var _a;
    let totalTime = 0;
 ...
 */
function dijkstra(start, end, changeTime) {
 ...
 */
function printTable(tableData, sheet, startCell, tableName) {
 ...
 */
function printStations(sheet, startCell) {
    /**
     * Affiche les stations dans un tableau.
     * @param {ExcelScript.Worksheet} sheet - La feuille de calcul où afficher le tableau.
     * @param {string} startCell - La cellule de départ du tableau.
